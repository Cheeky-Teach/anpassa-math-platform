...
export default function QuestionStudio({ onDoNowGenerate, ui, lang = 'sv', initialPacket }) {
  ...
  const TEXT = {
    sv: {
      ...
      donow_desc: "Rutnät för gemensam uppstart på tavlan.",
      ...
      basic_group: "Grundläggande",
      board_label: "Tavlan",
      new_example: "Nytt exempel",
      preview_error: "Kunde inte ladda förhandsgranskning",
      preview_error_hint: "Kontrollera att backend-generatorn är korrekt kopplad.",
      select_hint: "Välj variation för att förhandsgranska",
      hint_label: "Ledtråd",
      no_hint: "Ingen ledtråd tillgänglig.",
      ...
      <div className="w-[320px] bg-slate-50 border-r border-slate-200 flex flex-col overflow-hidden shrink-0">
        <div className="p-6 border-b border-slate-200 bg-white shrink-0 shadow-sm z-10">
            ...
            <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">
                {Object.keys(groupedVariations).length} {t.sections_label} • {currentTopic?.variations.length} {t.variants_label}
            </p>
        </div>
