                ...
                <main className="flex-1 max-w-6xl w-full mx-auto p-3 lg:p-6 overflow-hidden flex flex-col relative">
                    <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 lg:divide-x divide-slate-50 min-h-0">
                            ...
                            <div className="p-6 lg:p-10 bg-slate-50/30 border-t border-slate-100">
                                {!responses[currentIndex] ? (
                                    ...
                                    <div className="max-w-md mx-auto animate-in zoom-in-95 duration-300">
                                        {meta.mode === 'practice' ? (
                                            // PRACTICE MODE: Instant Correct/Incorrect Feedback
                        ...
                        {q?.resolvedData?.renderData && (q.resolvedData.renderData.graph || q.resolvedData.renderData.geometry || q.resolvedData.renderData.pattern) ? (
                            /* CHANGE: Added 'relative' to this parent. 
                            This creates a boundary for the absolute child.
                            */
                            <div className="p-6 lg:p-12 flex items-center justify-center bg-white order-2 h-full border-t lg:border-t-0 border-slate-50 relative overflow-hidden">
                                
                                {/* CHANGE: We use 'absolute inset-0' here. 
                                    This stops the ResizeObserver from being able to expand the parent div.
                                */}
